...
paths = [r'/var/www/eye.api/appsettings.Development.json',r'/var/www/eye.api/appsettings.json',r'/srv/eye.scheduler/appsettings.json',r'/srv/eye.scheduler/appsettings.Development.json']
for i in paths:
    file1 = open(i, 'r')
    app = file1.read()
    app = json.loads(app)
